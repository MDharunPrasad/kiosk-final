...
export function CounterStaffDashboard({ username }: CounterStaffDashboardProps) {
  ...
  const handleEditSession = () => {
    // Simulate editing
    alert(`Editing session: ${selectedSession.name}`);
  };
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-green-50 to-emerald-100 dark:from-slate-900 dark:to-slate-800 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        {/* Left Sidebar */}
        <div className="w-72 lg:w-80 bg-white dark:bg-slate-800 border-r border-border p-4 lg:p-6 flex flex-col flex-shrink-0">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden space-y-3 mb-4 min-h-0 min-w-0">
      ...
      <div className="flex-1 flex flex-col bg-white dark:bg-slate-800 min-w-0">
        <div className="flex-1 flex overflow-hidden min-h-0">
          ...
          <div className="flex-1 p-4 flex flex-col relative min-w-0">
            ...
            <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800 dark:to-slate-900 rounded-xl overflow-hidden flex items-center justify-center flex-1 min-h-0">
              <div className="absolute inset-0 flex items-center justify-center p-4">
                {selectedSession.images.length === 0 ? (
                  ...
                  >
                    ...
                    >
                      <button
                        className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-200 hover:bg-green-100 text-xl font-bold transition disabled:opacity-50"
